function thresholdSplatterLM = thresholdLM(acquisition)
...
if ~isempty(acquisition.validationAtThreshold) && ...
    ...
    % Convert to LMS
    thresholdSplatterLM = MeLMSens_Pulse.splatter.LminusMContrastFromBipolarReceptorContrasts(contrastActual);
else
