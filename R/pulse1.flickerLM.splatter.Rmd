...
ggplot(data = thresholds_splatter) +
  ...
  ggtitle("L-M splatter of flicker at thresholds (Pulse 1)") +
  theme_bw()
ggsave(here('figs','5CL.splatter.pulse.flickerLM.splatter.pdf'), width = 10, height = 5)
```
# Predict JNDs
...
ggplot(data = JNDs) +
    ...
    ggtitle("Predicted threshold, if flicker L-M splatter is considered (Pulse 1)")
ggsave(here('figs','5CR.JNDs.pulse.flickerLM.splatter.pdf'), width = 10, height = 5)
```