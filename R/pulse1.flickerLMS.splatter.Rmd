...
ggplot(data = thresholds_splatter) +
  ...
  ggtitle("LMS splatter of flicker (Pulse1)") +
  theme_bw()
ggsave(here('figs','S5A.splatter.pulse.flickerLMS.splatter.pdf'), width = 10, height = 5)
```
# Predict JNDs
...
plot_JNDs(JNDs) +
    ...
    ggtitle("Predicted threshold, if flicker LMS splatter is considered (Pulse1)")
ggsave(here('figs','S5B.JNDs.pulse.flickerLMS.splatter.pdf'), width = 10, height = 5)
```