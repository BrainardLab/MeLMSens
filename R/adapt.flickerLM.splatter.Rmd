...
ggplot(data = thresholds_splatter) +
  ...
  stat_summary(fun = median, geom = "point", aes(group=participant), size =1, alpha = .6, color = "Red") +
  stat_summary(fun = median, geom = "line", aes(group=participant), size =1, alpha = .6, color = "Red") +
  stat_summary(fun = median, fun.max = median_plus_sem, fun.min = median_minus_sem,
               geom = "linerange", aes(group = participant), size =1, alpha = .6, color = "Red") +  
