...
ggplot(data = thresholds_splatter) +
  ...
  stat_summary(fun = median, geom = "point", aes(group=participant), size =1, alpha = .7, position=position_dodge(width = .08)) +
  stat_summary(fun = median, geom = "line", aes(group=participant), size =1,alpha = .7, position=position_dodge(width = .08)) +
  stat_summary(fun = median, fun.max = median_plus_sem, fun.min = median_minus_sem,
               geom = "linerange", aes(group = participant), size =1,alpha = .4, position=position_dodge(width = .08)) +  
...
ggplot(data = JNDs) +
    ...
    # Plot median for each participant
    stat_summary(fun = median, geom = "point", aes(group=participant), size =1, alpha = .6, color = "blue") +
    stat_summary(fun = median, geom = "line", aes(group=participant), size =1, alpha = .6, color = "blue") +
    stat_summary(fun = median, fun.max = median_plus_sem, fun.min = median_minus_sem,
                 geom = "linerange", aes(group = participant), size =1, alpha = .6, color = "blue") +
